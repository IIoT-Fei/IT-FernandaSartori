...
class Lab(db.Model):
    ...
    #nomearquivo= db.Column(db.String(100))
    codigo_saida = db.Column(db.String(1000))
    codigo_subs = db.Column(db.String(1000))
    #     # construtor
    def __init__(self, titulo, arquivo, datahora, disciplina_id, excluir, visivel, codigo_saida, codigo_subs):
        self.titulo = titulo
...
class Envios(db.Model):
    ...
    linguagem = db.Column(db.String(50))


    def __init__(self, status, mensagem, cod_user, cod_lab, datahora, nome, linguagem ):
        self.status = status
